      ...
      <div className="relative w-full flex flex-col items-center justify-center bg-gray-100 px-10">
        <AnimatePresence mode='wait'>
          ...
          >
            ...
            <h2 className="max-w-[747px] font-chronicle font-bold text-[25px] leading-[42px] tracking-[0px]">{texts[currentIndex].heading}</h2>
        ...
        <div className="flex space-x-3 pt-[50px]">
          {texts.map((_, index) => (
            <div
              ...
              className={`w-2 h-2 cursor-pointer rounded-full border border-teal ${index === currentIndex ? 'bg-teal' : 'bg-transparent'
                }`}
            />
          ))}
        </div>
