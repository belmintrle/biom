...
const ButtonIcon = ( props ) => {
  return(
    <a href={props.link} className={`group border border-teal-dark transition-colors duration-300 ease-out rounded-[6px] w-min whitespace-nowrap font-brandon font-black text-[13px] leading-[16px] tracking-[1.3px] text-teal uppercase flex flex-row ${props.className}`}>
      <div className="px-[15px] py-[15px] flex justify-center items-center">{props.label}</div>
...
const ButtonIconIg = ( props ) => {
  return(
    <a href={props.link} className={`group border border-teal-dark transition-colors duration-300 ease-out rounded-[6px] w-min whitespace-nowrap font-brandon font-black text-[13px] leading-[13px] tracking-[1.3px] text-teal uppercase flex flex-row overflow-hidden ${props.className}`}>
      <div className="px-[15px] py-[15px] flex justify-center items-center">{props.label}</div>
